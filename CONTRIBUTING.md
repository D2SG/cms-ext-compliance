...
- Test across locales if touching content-driven components
- Ensure accessibility (semantic HTML, ARIA attributes, keyboard navigation)

## Reporting Issues

Use [GitHub Issues](https://github.com/koehler8/cms-ext-compliance/issues) to report bugs or request features.
